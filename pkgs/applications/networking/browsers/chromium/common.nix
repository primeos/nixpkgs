...
, useOzone ? false
, useVaapi ? !useOzone # TODO: M81 fails to build due to "ozone_platform_gbm = false"
# Possible solutions: Write a patch to fix the build (wrong gn dependencies) or
# build with minigbm
# VA-API note: Build by default, but disabled in the wrapper
